...
<!-- Header include-->
	...
	<?php include('../template/arrow.php'); ?>
	<div class="background"></div>
	<div class="main-container">
		<div class="main-text">
			<h1>Jesteśmy <span class="letter-decoration">O</span>Z<span class="letter-decoration">O</span>NE,</h1>
		</div>	
	...
	<div class="col-socialmedia">
		<div class="col-socialmedia-items">
			<a href="#">
	...
	<div class="baner-container">
		<div class="baner-header space">
			<h2>Meet the CREW</h2>
		</div>
		<div class="baner-image">
			<i class="fas fa-arrow-left navigation-tools"></i>
			<img src="../media/person1.jpg" class="img-fluid slider">
	...
	<script text="js" src="../js/header.js"></script>
	<script text="js" src="../js/aboutus.js"></script>
	<script text="js" src="../js/baner-slider.js"></script>
</body>
</html>